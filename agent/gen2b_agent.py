...
async def resume_owner_turn(session: AgentSession, decision: dict[str, str]) -> None:
    ...
    session.generate_reply(
        ...
        instructions=(
            ...
            "Разговор уже начат: не здоровайся, не представляйся и не повторяй исходный запрос. "
            "Сразу передай только ответ Армена в контексте последнего вопроса собеседника. "
